...
public:
	...
	virtual int GetWeaponID( void ) const		{ return CS_WEAPON_AK47; }
...
LINK_ENTITY_TO_CLASS( cs_weapon_ak47, CAK47 );
PRECACHE_WEAPON_REGISTER( cs_weapon_ak47 );
...
void CAK47::PrimaryAttack()
{
	...
	if ( !CSBaseGunFire( GetPCWpnData().m_CSWeaponData.m_flCycleTime, TF_WEAPON_PRIMARY_MODE ) )
		return;
