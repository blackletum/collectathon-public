...
public:
	...
	TF_Gamestats_ClassStats_t		m_aClassStats[GAME_CLASS_COUNT];	// Vector of class data
	TF_Gamestats_WeaponStats_t		m_aWeaponStats[GAME_WEAPON_COUNT];	// Vector of weapon data
	// Temporary data.
