...
enum WEAPON_TYPE
{
	WEAPON_TF, // Team Fortress 2
	WEAPON_DOD, // Day of Defeat
	WEAPON_PC, // Original Characters
	WEAPON_CS, // Day of Defeat
...
public:
	...
	virtual int				SetClip1(int iCount) { return m_iClip1 = iCount; }
	virtual int				SetClip2(int iCount) { return m_iClip2 = iCount; }
...
protected:
#if defined ( TF_CLIENT_DLL ) || defined ( TF_DLL ) || defined ( TF_BASE )
...
public:
	...
	virtual int  GetWeaponTypeReference( void ) { return WEAPON_DEFAULT; }
