...
enum
{
	GESTURE_SLOT_ATTACK_AND_RELOAD, // DOD Attack
	GESTURE_SLOT_GRENADE, // DOD Reload
	GESTURE_SLOT_JUMP, // DOD Fidget
	GESTURE_SLOT_SWIM, // DOD Hand Signal
	GESTURE_SLOT_FLINCH, // DOD Plant
	GESTURE_SLOT_VCD, // DOD Defuse
	GESTURE_SLOT_CUSTOM,
...
inline Activity CMultiPlayerAnimState::GetCurrentMainSequenceActivity() const
{
	return m_eCurrentMainSequenceActivity;
}

CMultiPlayerAnimState* CreatePlayerAnimState( CBasePlayer *pPlayer );
