...
#if defined( DOD_DLL ) || defined( CSTRIKE_DLL ) || defined( HL1MP_DLL ) || defined( TF_DLL ) || defined ( TF_BASE_SERVER )
...
#if defined( CSTRIKE_DLL ) || defined( HL1MP_DLL ) || defined( TF_DLL ) || defined ( TF_BASE_SERVER )
