...
public:
	...
	virtual int GetWeaponID( void ) const		{ return DOD_WEAPON_M1CARBINE; }
...
LINK_ENTITY_TO_CLASS( dod_weapon_m1carbine, CWeaponM1Carbine );
PRECACHE_WEAPON_REGISTER( dod_weapon_m1carbine );
