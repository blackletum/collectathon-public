...
public:
	...
	virtual int GetWeaponID( void ) const		{ return DOD_WEAPON_MP40; }
	virtual int GetAltWeaponID( void ) const	{ return DOD_WEAPON_MP40_PUNCH; }
...
LINK_ENTITY_TO_CLASS( dod_weapon_mp40, CWeaponMP40 );
PRECACHE_WEAPON_REGISTER( dod_weapon_mp40 );
