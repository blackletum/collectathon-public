...
public:
	...
	virtual int GetWeaponID( void ) const		{ return DOD_WEAPON_PSCHRECK; }
...
LINK_ENTITY_TO_CLASS( dod_weapon_pschreck, CWeaponPschreck );
PRECACHE_WEAPON_REGISTER( dod_weapon_pschreck );
