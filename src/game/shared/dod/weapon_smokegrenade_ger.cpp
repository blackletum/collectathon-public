...
public:
	...
	virtual int GetWeaponID( void ) const		{ return DOD_WEAPON_SMOKE_GER; }
...
LINK_ENTITY_TO_CLASS( dod_weapon_smoke_ger, CWeaponSmokeGrenadeGER );
PRECACHE_WEAPON_REGISTER( dod_weapon_smoke_ger );