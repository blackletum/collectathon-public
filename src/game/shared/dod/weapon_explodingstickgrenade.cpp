...
public:
	...
	virtual int GetWeaponID( void ) const		{ return DOD_WEAPON_FRAG_GER_LIVE; }
...
LINK_ENTITY_TO_CLASS( dod_weapon_frag_ger_live, CWeaponExplodingStickGrenade );
PRECACHE_WEAPON_REGISTER( dod_weapon_frag_ger_live );