...
public:
	...
	virtual int GetWeaponID( void ) const		{ return DOD_WEAPON_FRAG_US; }
...
LINK_ENTITY_TO_CLASS( dod_weapon_frag_us, CWeaponHandGrenade );
PRECACHE_WEAPON_REGISTER( dod_weapon_frag_us );