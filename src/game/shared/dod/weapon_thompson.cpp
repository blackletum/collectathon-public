...
public:
	...
	virtual int GetWeaponID( void ) const		{ return DOD_WEAPON_THOMPSON; }
	virtual int GetAltWeaponID( void ) const	{ return DOD_WEAPON_THOMPSON_PUNCH; }
...
LINK_ENTITY_TO_CLASS( dod_weapon_thompson, CWeaponThompson );
PRECACHE_WEAPON_REGISTER( dod_weapon_thompson );
