...
public:
	...
	virtual int GetWeaponID( void ) const		{ return DOD_WEAPON_SMOKE_US; }
...
LINK_ENTITY_TO_CLASS( dod_weapon_smoke_us, CWeaponSmokeGrenadeUS );
PRECACHE_WEAPON_REGISTER( dod_weapon_smoke_us );