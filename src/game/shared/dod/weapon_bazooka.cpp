...
public:
	...
	virtual int GetWeaponID( void ) const		{ return DOD_WEAPON_BAZOOKA; }
...
LINK_ENTITY_TO_CLASS( dod_weapon_bazooka, CWeaponBazooka );
PRECACHE_WEAPON_REGISTER( dod_weapon_bazooka );
