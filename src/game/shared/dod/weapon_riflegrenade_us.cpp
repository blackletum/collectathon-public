...
public:
	...
	virtual int GetWeaponID( void ) const		{ return DOD_WEAPON_RIFLEGREN_US; }
...
LINK_ENTITY_TO_CLASS( dod_weapon_riflegren_us, CWeaponRifleGrenadeUS );
PRECACHE_WEAPON_REGISTER( dod_weapon_riflegren_us );
