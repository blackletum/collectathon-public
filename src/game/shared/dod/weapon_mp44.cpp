...
public:
	...
	virtual int GetWeaponID( void ) const		{ return DOD_WEAPON_MP44; }

	// weapon id for stats purposes
	virtual int GetStatsWeaponID( void )
	{
		if ( IsSemiAuto() )
			return DOD_WEAPON_MP44_SEMIAUTO;
		else 
...
LINK_ENTITY_TO_CLASS( dod_weapon_mp44, CWeaponMP44 );
PRECACHE_WEAPON_REGISTER( dod_weapon_mp44 );
