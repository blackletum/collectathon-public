...
public:
	...
	virtual int GetWeaponID( void ) const		{ return DOD_WEAPON_RIFLEGREN_US_LIVE; }
...
LINK_ENTITY_TO_CLASS( dod_weapon_riflegren_us_live, CWeaponRifleGrenadeUS_Live );
PRECACHE_WEAPON_REGISTER( dod_weapon_riflegren_us_live );