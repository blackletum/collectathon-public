...
public:
	...
	virtual int GetWeaponID( void ) const		{ return DOD_WEAPON_RIFLEGREN_GER; }
...
LINK_ENTITY_TO_CLASS( dod_weapon_riflegren_ger, CWeaponRifleGrenadeGER );
PRECACHE_WEAPON_REGISTER( dod_weapon_riflegren_ger );
