...
#define VEC_VIEW_DOD( player )				( TFGameRules()->GetDODViewVectors()->m_vView )
#define VEC_HULL_MIN_DOD( player )			( TFGameRules()->GetDODViewVectors()->m_vHullMin )
#define VEC_HULL_MAX_DOD( player )			( TFGameRules()->GetDODViewVectors()->m_vHullMax )

#define VEC_DUCK_HULL_MIN_DOD( player )		( TFGameRules()->GetDODViewVectors()->m_vDuckHullMin )
#define VEC_DUCK_HULL_MAX_DOD( player )		( TFGameRules()->GetDODViewVectors()->m_vDuckHullMax )
#define VEC_DUCK_VIEW_DOD( player )			( TFGameRules()->GetDODViewVectors()->m_vDuckView )

#define VEC_OBS_HULL_MIN_DOD( player )		( TFGameRules()->GetDODViewVectors()->m_vObsHullMin )
#define VEC_OBS_HULL_MAX_DOD( player )		( TFGameRules()->GetDODViewVectors()->m_vObsHullMax )

#define VEC_DEAD_VIEWHEIGHT_DOD( player )	( TFGameRules()->GetDODViewVectors()->m_vDeadViewHeight )

#define VEC_VIEW_SCALED_DOD( player )				( TFGameRules()->GetDODViewVectors()->m_vView * player->GetModelScale() )
#define VEC_HULL_MIN_SCALED_DOD( player )			( TFGameRules()->GetDODViewVectors()->m_vHullMin * player->GetModelScale() )
#define VEC_HULL_MAX_SCALED_DOD( player )			( TFGameRules()->GetDODViewVectors()->m_vHullMax * player->GetModelScale() )

#define VEC_DUCK_HULL_MIN_SCALED_DOD( player )		( TFGameRules()->GetDODViewVectors()->m_vDuckHullMin * player->GetModelScale() )
#define VEC_DUCK_HULL_MAX_SCALED_DOD( player )		( TFGameRules()->GetDODViewVectors()->m_vDuckHullMax * player->GetModelScale() )
#define VEC_DUCK_VIEW_SCALED_DOD( player )			( TFGameRules()->GetDODViewVectors()->m_vDuckView * player->GetModelScale() )

#define VEC_OBS_HULL_MIN_SCALED_DOD( player )		( TFGameRules()->GetDODViewVectors()->m_vObsHullMin * player->GetModelScale() )
#define VEC_OBS_HULL_MAX_SCALED_DOD( player )		( TFGameRules()->GetDODViewVectors()->m_vObsHullMax * player->GetModelScale() )

#define VEC_DEAD_VIEWHEIGHT_SCALED_DOD( player )	( TFGameRules()->GetDODViewVectors()->m_vDeadViewHeight * player->GetModelScale() )
...
#define DOD_PLAYER_WEAPON_COUNT		3
#define DOD_PLAYER_GRENADE_COUNT	2	
...
#define VEC_PRONE_HULL_MIN	TFGameRules()->GetDODViewVectors()->m_vProneHullMin
#define VEC_PRONE_HULL_MAX	TFGameRules()->GetDODViewVectors()->m_vProneHullMax	// MUST be shorter than duck hull for deploy check

#define VEC_PRONE_HULL_MIN_SCALED( player )	( TFGameRules()->GetDODViewVectors()->m_vProneHullMin * player->GetModelScale() )
#define VEC_PRONE_HULL_MAX_SCALED( player )	( TFGameRules()->GetDODViewVectors()->m_vProneHullMax * player->GetModelScale() )
...
extern const char *g_pszDODHintMessages[];
...
// eject brass shells
#define DOD_EJECTBRASS_PISTOL		0
#define DOD_EJECTBRASS_RIFLE		1
#define DOD_EJECTBRASS_MG			2
#define DOD_EJECTBRASS_MG_2			3	// ?
#define DOD_EJECTBRASS_GARANDCLIP	4
