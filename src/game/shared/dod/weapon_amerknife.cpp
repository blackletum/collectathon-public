...
public:
	...
	virtual int GetWeaponID( void ) const { return DOD_WEAPON_AMERKNIFE; }

	virtual void PrimaryAttack()
	{
		MeleeAttack( 60, DOD_DMG_CUSTOM_MELEE_FIST, 0.2f, 0.4f );
	}
...
LINK_ENTITY_TO_CLASS( dod_weapon_amerknife, CWeaponAmerKnife );
PRECACHE_WEAPON_REGISTER( dod_weapon_amerknife );
