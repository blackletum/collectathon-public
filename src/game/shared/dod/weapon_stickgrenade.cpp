...
public:
	...
	virtual int GetWeaponID( void ) const		{ return DOD_WEAPON_FRAG_GER; }
...
LINK_ENTITY_TO_CLASS( dod_weapon_frag_ger, CWeaponStickGrenade );
PRECACHE_WEAPON_REGISTER( dod_weapon_frag_ger );
