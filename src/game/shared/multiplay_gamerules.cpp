...
#if !( defined( TF_DLL ) || defined ( TF_BASE ) )		// TF overrides the default value of this convar
...
#if defined( CSTRIKE_DLL ) || defined( TF_DLL ) || defined ( TF_BASE )
...
bool CMultiplayRules::Init()
{
	...
	// override some values for multiplay.
		...
		// suitcharger
#if !( defined( TF_DLL ) || defined ( TF_BASE ) )
//=============================================================================
// HPE_BEGIN:
