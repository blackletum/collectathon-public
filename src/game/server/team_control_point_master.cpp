...
BEGIN_DATADESC( CTeamControlPointMaster )
	...
	DEFINE_KEYFIELD( m_bRequirePreviousPoints, FIELD_BOOLEAN, "require_previouspoints" ),
	DEFINE_KEYFIELD( m_bPlayCapSounds, FIELD_BOOLEAN, "play_cap_sounds" ),
...
CTeamControlPointMaster::CTeamControlPointMaster()
{
	...
	m_bRequirePreviousPoints = true;
	m_bPlayCapSounds = true;
}
...
bool CTeamControlPointMaster::FindControlPointRounds( void )
{
	...
	if ( g_pObjectiveResource )
	{
		...
		g_pObjectiveResource->SetShouldRequirePreviousPoints( m_bRequirePreviousPoints );
	}
