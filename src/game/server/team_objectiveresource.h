...
public:
	...
	void SetShouldRequirePreviousPoints( bool bShouldRequire ) { m_bRequirePreviousPoints = bShouldRequire; }
	bool GetShouldRequirePreviousPoints( void ) { return m_bRequirePreviousPoints; }
...
private:
	...
	CNetworkVar( bool, m_bRequirePreviousPoints );
};
