...
void CDODBaseRocket::Precache( void )
{
	...
	PrecacheParticleSystem( "rockettrail_dod" );
}
...
*/
	...
	TFGameRules()->RadiusStun( stunInfo, GetAbsOrigin(), flRadius );
}
...
//-----------------------------------------------------------------------------
void CDODBaseRocket::Deflected( CBaseEntity *pDeflectedBy, Vector &vecDir )
{
