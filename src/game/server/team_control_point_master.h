...
public:
	...
	bool ShouldRequirePreviousPoints( void ){ return m_bRequirePreviousPoints; }
	bool ShouldPlayCapSounds( void ){ return m_bPlayCapSounds; }
...
private:
	...
	bool m_bRequirePreviousPoints;
	bool m_bPlayCapSounds;
};
