...
public:
	...
	virtual void			PlayerUse( bool bPushAway = true );
...
public:
	void  SetGameAnimStateType( CMultiPlayerAnimState *pAnimStateType ) { m_pAnimState = pAnimStateType; }
	CMultiPlayerAnimState *GetGameAnimStateType( void ) { return m_pAnimState; }

	void  SetGameMovementType( CGameMovement *pMoveType ) { m_pMovement = pMoveType; }
	CGameMovement *GetGameMovementType( void ) { return m_pMovement; }
