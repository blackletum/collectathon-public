...
#define BASE CBaseHudWeaponSelection
#define DEFAULT "CHudWeaponSelection"
#define DOD "CDODHudWeaponSelection"
#define CS "CCSHudWeaponSelection"
#define HL2 "CHL2HudWeaponSelection"

DECLARE_HUD_COMMAND_NAME_FUCK( BASE, Slot1, DEFAULT, DOD, CS, HL2 );
DECLARE_HUD_COMMAND_NAME_FUCK( BASE, Slot2, DEFAULT, DOD, CS, HL2);
DECLARE_HUD_COMMAND_NAME_FUCK( BASE, Slot3, DEFAULT, DOD, CS, HL2);
DECLARE_HUD_COMMAND_NAME_FUCK( BASE, Slot4, DEFAULT, DOD, CS, HL2);
DECLARE_HUD_COMMAND_NAME_FUCK( BASE, Slot5, DEFAULT, DOD, CS, HL2);
DECLARE_HUD_COMMAND_NAME_FUCK( BASE, Slot6, DEFAULT, DOD, CS, HL2);
DECLARE_HUD_COMMAND_NAME_FUCK( BASE, Slot7, DEFAULT, DOD, CS, HL2);
DECLARE_HUD_COMMAND_NAME_FUCK( BASE, Slot8, DEFAULT, DOD, CS, HL2);
DECLARE_HUD_COMMAND_NAME_FUCK( BASE, Slot9, DEFAULT, DOD, CS, HL2);
DECLARE_HUD_COMMAND_NAME_FUCK( BASE, Slot0, DEFAULT, DOD, CS, HL2);
DECLARE_HUD_COMMAND_NAME_FUCK( BASE, Slot10, DEFAULT, DOD, CS, HL2);
DECLARE_HUD_COMMAND_NAME_FUCK( BASE, Close, DEFAULT, DOD, CS, HL2);
DECLARE_HUD_COMMAND_NAME_FUCK( BASE, NextWeapon, DEFAULT, DOD, CS, HL2);
DECLARE_HUD_COMMAND_NAME_FUCK( BASE, PrevWeapon, DEFAULT, DOD, CS, HL2);
DECLARE_HUD_COMMAND_NAME_FUCK( BASE, LastWeapon, DEFAULT, DOD, CS, HL2);
...
void CBaseHudWeaponSelection::ProcessInput()
{
	...
	if ( gHUD.m_iKeyBits & (IN_ATTACK | IN_ATTACK2) )
	{
		...
		{
#if !( defined( TF_CLIENT_DLL ) || defined( TF_BASE ) )
			if ( HUDTYPE_PLUS != nFastswitchMode )
#endif
			{
				// Swallow the button
