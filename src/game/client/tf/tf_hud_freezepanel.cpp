...
void CTFFreezePanel::ApplySchemeSettings( vgui::IScheme *pScheme )
{
	...
	// WE'RE GONNA KILL THIS HAHAHAHA
	m_pItemPanel = dynamic_cast<EditablePanel *>( FindChildByName("itempanel") );
	...
	if ( m_pItemPanel )
		m_pBasePanel->GetBounds( m_iItemPanelOriginalX, m_iItemPanelOriginalY, w, h );
