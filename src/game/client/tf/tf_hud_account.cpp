...
// Colour Combattext Commands
// Negative
ConVar hud_combattext_negative_override( "hud_combattext_negative_override", "1", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
...
ConVar hud_combattext_alpha( "hud_combattext_alpha", "255", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
// Positive
ConVar hud_combattext_positive_override( "hud_combattext_positive_override", "1", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
ConVar hud_combattext_positive_red( "hud_combattext_positive_red", "0", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
ConVar hud_combattext_positive_green( "hud_combattext_positive_green", "255", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
ConVar hud_combattext_positive_blue( "hud_combattext_positive_blue", "0", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
ConVar hud_combattext_positive_alpha( "hud_combattext_positive_alpha", "255", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
// Event
ConVar hud_combattext_event_override( "hud_combattext_event_override", "1", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
ConVar hud_combattext_event_red( "hud_combattext_event_red", "255", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
ConVar hud_combattext_event_green( "hud_combattext_event_green", "0", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
ConVar hud_combattext_event_blue( "hud_combattext_event_blue", "255", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
ConVar hud_combattext_event_alpha( "hud_combattext_event_alpha", "255", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
// Robot Destruction Score Colour
// Red
ConVar hud_combattext_rd_red_score_override( "hud_combattext_rd_red_score_override", "1", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
ConVar hud_combattext_rd_red_score_red( "hud_combattext_rd_red_score_red", "255", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
ConVar hud_combattext_rd_red_score_green( "hud_combattext_rd_red_score_green", "0", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
ConVar hud_combattext_rd_red_score_blue( "hud_combattext_rd_red_score_blue", "0", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
ConVar hud_combattext_rd_red_score_alpha( "hud_combattext_rd_red_score_alpha", "255", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
// Blue
ConVar hud_combattext_rd_blu_score_override( "hud_combattext_rd_blu_score_override", "1", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
ConVar hud_combattext_rd_blu_score_red( "hud_combattext_rd_blu_score_red", "0", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
ConVar hud_combattext_rd_blu_score_green( "hud_combattext_rd_blu_score_green", "166", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
ConVar hud_combattext_rd_blu_score_blue( "hud_combattext_rd_blu_score_blue", "255", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
ConVar hud_combattext_rd_blu_score_alpha( "hud_combattext_rd_blu_score_alpha", "255", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX );
	...
	virtual void FireGameEvent( IGameEvent *event ) OVERRIDE
	{
		...
		if ( Q_strcmp(pszEventName, m_pszEventName) == 0 )
		{
			...
			if ( pNewAccount )
			{
				...
				{
					if ( hud_combattext_positive_override.GetBool() )
						pNewAccount->m_color = Color( hud_combattext_positive_red.GetInt(),
							hud_combattext_positive_green.GetInt(),
							hud_combattext_positive_blue.GetInt(),
							hud_combattext_positive_alpha.GetInt() );
					else
						pNewAccount->m_color = m_DeltaPositiveColor;
				}
				else
				{
					if ( hud_combattext_negative_override.GetBool() )
						pNewAccount->m_color = Color( hud_combattext_red.GetInt(),
							hud_combattext_green.GetInt(),
							hud_combattext_blue.GetInt(),
							hud_combattext_alpha.GetInt() );
					else
...
Color CAccountPanel::GetColor( const account_delta_t::eAccountDeltaType_t& type )
{
	...
	{
		if ( hud_combattext_event_override.GetBool() )
			return Color( hud_combattext_event_red.GetInt(),
				hud_combattext_event_green.GetInt(),
				hud_combattext_event_blue.GetInt(),
				hud_combattext_event_alpha.GetInt() );
		else
	...
	{
		if ( hud_combattext_positive_override.GetBool() )
			return Color( hud_combattext_positive_red.GetInt(),
				hud_combattext_positive_green.GetInt(),
				hud_combattext_positive_blue.GetInt(),
				hud_combattext_positive_alpha.GetInt() );
		else
	...
	{
		if ( hud_combattext_negative_override.GetBool() )
			return Color( hud_combattext_red.GetInt(),
				hud_combattext_green.GetInt(),
				hud_combattext_blue.GetInt(),
				hud_combattext_alpha.GetInt() );
		else
	...
	{
		if ( hud_combattext_rd_blu_score_override.GetBool() )
			return Color( hud_combattext_rd_blu_score_red.GetInt(),
				hud_combattext_rd_blu_score_green.GetInt(),
				hud_combattext_rd_blu_score_blue.GetInt(),
				hud_combattext_rd_blu_score_alpha.GetInt() );
		else
			return m_DeltaBlueRobotScoreColor;
	}
	else if ( type == account_delta_t::ACCOUNT_DELTA_ROBOT_DESTRUCTION_POINT_RED )
	{
		if ( hud_combattext_rd_red_score_override.GetBool() )
			return Color( hud_combattext_rd_red_score_red.GetInt(),
				hud_combattext_rd_red_score_green.GetInt(),
				hud_combattext_rd_red_score_blue.GetInt(),
				hud_combattext_rd_red_score_alpha.GetInt() );
		else
