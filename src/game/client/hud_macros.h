...
// SEALTODO WOW THIS SUCKS FUCKING DICK THERE HAS TO BE A BETTER WAY?!?!
#define DECLARE_HUD_COMMAND_NAME_FUCK(y, x, name, name2, name3, name4) void __CmdFunc_##x( void )									\
	{																\
		CHudElement *pElement = gHUD.FindElement( name );			\
		{															\
			((y *)pElement)->UserCmd_##x( );						\
																	...
																	\
		CHudElement *pElement2 = gHUD.FindElement( name2 );			\
		{															\
			((y *)pElement2)->UserCmd_##x( );						\
		}															\
		CHudElement *pElement3 = gHUD.FindElement( name3 );			\
		{															\
			((y *)pElement3)->UserCmd_##x( );						\
		}															\
		CHudElement *pElement4 = gHUD.FindElement( name4 );			\
		{															\
			((y *)pElement4)->UserCmd_##x( );						\
		}															\
	}
