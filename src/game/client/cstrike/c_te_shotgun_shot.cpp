...
class C_TECSFireBullets : public C_BaseTempEntity
{
public:
	DECLARE_CLASS( C_TECSFireBullets, C_BaseTempEntity );
	DECLARE_CLIENTCLASS();
...
void C_TECSFireBullets::PostDataUpdate( DataUpdateType_t updateType )
{
	// Create the effect.
...
IMPLEMENT_CLIENTCLASS_EVENT( C_TECSFireBullets, DT_TECSFireBullets, CTECSFireBullets );


BEGIN_RECV_TABLE_NOBASE(C_TECSFireBullets, DT_TECSFireBullets)
