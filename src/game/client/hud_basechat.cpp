...
// cl_enable_text_chat will stil display in-game messages sent directly i.e if a player joins a team or leaves the game.
ConVar cl_enable_text_chat( "cl_enable_text_chat", "1", FCVAR_ARCHIVE, "If 0, text chat will be disabled and will not display any messages from players." );
