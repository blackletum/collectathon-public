...
private:
	...
	void PaintGrenadeAmmo( CPCWeaponBase *pWpn );
	void PaintBazookaAmmo( CPCWeaponBase *pWpn );
	void PaintMGAmmo( CPCWeaponBase *pWpn );
	void PaintGunAmmo( CPCWeaponBase *pWpn );
	void PaintRifleGrenadeAmmo( CPCWeaponBase *pWpn );
...
void CHudAmmo::PaintGrenadeAmmo( CPCWeaponBase *pWpn )
{
...
void CHudAmmo::PaintRifleGrenadeAmmo( CPCWeaponBase *pWpn )
{
	const CHudTexture *pAmmoIcon = pWpn->GetSpriteAmmo();
...
void CHudAmmo::PaintBazookaAmmo( CPCWeaponBase *pWpn )
{	
...
void CHudAmmo::PaintMGAmmo( CPCWeaponBase *pWpn )
{
...
void CHudAmmo::PaintGunAmmo( CPCWeaponBase *pWpn )
{
	//regular gun
	...
	if( pEmptyClip )
	{
		...
		float flBasePercent			= (float)pWpn->GetPCWpnData().m_DODWeaponData.m_iHudClipBaseHeight / (float)pWpn->GetPCWpnData().m_DODWeaponData.m_iHudClipHeight;
		float flBulletHeightPercent = (float)pWpn->GetPCWpnData().m_DODWeaponData.m_iHudClipBulletHeight / (float)pWpn->GetPCWpnData().m_DODWeaponData.m_iHudClipHeight;
...
void CHudAmmo::Paint( void )
{
	...
	switch( pWpn->GetPCWpnData().m_DODWeaponData.m_WeaponType )
	{
