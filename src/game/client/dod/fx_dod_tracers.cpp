...
void FX_DODFaintTracer( Vector& start, Vector& end )
{
...
void FX_DODBrightTracer( Vector& start, Vector& end )
{
	//Don't make small tracers
	float dist;
	Vector dir;
...
//-----------------------------------------------------------------------------
void DODFaintTracerCallback( const CEffectData &data )
{
	FX_DODFaintTracer( (Vector&)data.m_vStart, (Vector&)data.m_vOrigin );
}
...
//-----------------------------------------------------------------------------
void DODBrightTracerCallback( const CEffectData &data )
{
	FX_DODBrightTracer( (Vector&)data.m_vStart, (Vector&)data.m_vOrigin );
}

DECLARE_CLIENT_EFFECT( "DODFaintTracer", DODFaintTracerCallback );
DECLARE_CLIENT_EFFECT( "DODBrightTracer", DODBrightTracerCallback );