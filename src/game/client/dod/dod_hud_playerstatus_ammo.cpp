...
void CDoDHudAmmo::ApplySchemeSettings( vgui::IScheme *pScheme )
{
	...
	m_clrTextColor = pScheme->GetColor( "DOD_HudAmmoCount", GetFgColor() );
	m_clrTextXColor = pScheme->GetColor( "DOD_HudPanelBorder", GetFgColor() );
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CDoDHudAmmo::PaintGrenadeAmmo( CPCWeaponBase *pWpn )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CDoDHudAmmo::PaintRifleGrenadeAmmo( CPCWeaponBase *pWpn )
{
	const CHudTexture *pAmmoIcon = pWpn->GetSpriteAmmo();
...
// Purpose: 
//-----------------------------------------------------------------------------
void CDoDHudAmmo::PaintBazookaAmmo( CPCWeaponBase *pWpn )
{	
...
// Purpose: 
//-----------------------------------------------------------------------------
void CDoDHudAmmo::PaintMGAmmo( CPCWeaponBase *pWpn )
{
	int panelX, panelY, panelW, panelT;
	GetBounds( panelX, panelY, panelW, panelT );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CDoDHudAmmo::PaintGunAmmo( CPCWeaponBase *pWpn )
{
	int panelX, panelY, panelW, panelT;
	GetBounds( panelX, panelY, panelW, panelT );
