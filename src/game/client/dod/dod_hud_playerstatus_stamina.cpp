...
void CDoDHudStaminaProgressBar::ApplySchemeSettings( vgui::IScheme *pScheme )
{
	...
	m_clrActive = pScheme->GetColor( "DOD_HudStaminaBar.Active", GetFgColor() );
	m_clrActiveLow = pScheme->GetColor( "DOD_HudStaminaBar.ActiveLow", GetFgColor() );
	m_clrInactive = pScheme->GetColor( "DOD_HudStaminaBar.InActive", GetFgColor() );
	m_clrInactiveLow = pScheme->GetColor( "DOD_HudStaminaBar.InActiveLow", GetFgColor() );
}
...
void CDoDHudStaminaIcon::ApplySchemeSettings( vgui::IScheme *pScheme )
{
	...
	m_clrActive = pScheme->GetColor( "DOD_HudStaminaIcon.Active", GetFgColor() );
	m_clrActiveLow = pScheme->GetColor( "DOD_HudStaminaIcon.ActiveLow", GetFgColor() );
