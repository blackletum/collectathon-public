...
void CDoDHudMGHeatProgressBar::ApplySchemeSettings( vgui::IScheme *pScheme )
{
	...
	m_clrActive = pScheme->GetColor( "DOD_HudMGHeatBar.Active", GetFgColor() );
	m_clrActiveLow = pScheme->GetColor( "DOD_HudMGHeatBar.ActiveLow", GetFgColor() );
	m_clrInactive = pScheme->GetColor( "DOD_HudMGHeatBar.InActive", GetFgColor() );
	m_clrInactiveLow = pScheme->GetColor( "DOD_HudMGHeatBar.InActiveLow", GetFgColor() );
}
...
void CDoDHudMGHeatIcon::ApplySchemeSettings( vgui::IScheme *pScheme )
{
	...
	m_clrActive = pScheme->GetColor( "DOD_HudMGHeatIcon.Active", GetFgColor() );
	m_clrActiveLow = pScheme->GetColor( "DOD_HudMGHeatIcon.ActiveLow", GetFgColor() );
}
...
*/
			if ( pWeapon->IsWeapon( DOD_WEAPON_MG42 ) )
			{
				...
				if ( m_pIcon )
				{
					m_pIcon->SetType( DOD_WEAPON_MG42 );
				}
