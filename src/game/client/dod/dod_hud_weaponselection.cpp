...
//-----------------------------------------------------------------------------
class CDODHudWeaponSelection : public CBaseHudWeaponSelection, public vgui::Panel
{
	DECLARE_CLASS_SIMPLE( CDODHudWeaponSelection, vgui::Panel );

public:
	CDODHudWeaponSelection( const char *pElementName );
...
private:
	...
	CPanelAnimationVar( vgui::HFont, m_hNumberFont, "NumberFont", "DOD_HudSelectionNumbers" );
	CPanelAnimationVar( vgui::HFont, m_hTextFont, "TextFont", "DOD_HudSelectionText" );

	CPanelAnimationVar( Color, m_TextColor, "TextColor", "DOD_SelectionTextFg" );
	CPanelAnimationVar( Color, m_NumberColor, "NumberColor", "DOD_SelectionNumberFg" );
	CPanelAnimationVar( Color, m_EmptyBoxColor, "EmptyBoxColor", "DOD_SelectionEmptyBoxBg" );
	CPanelAnimationVar( Color, m_BoxColor, "BoxColor", "DOD_SelectionBoxBg" );
	CPanelAnimationVar( Color, m_SelectedBoxColor, "SelectedBoxClor", "DOD_SelectionSelectedBoxBg" );
...
DECLARE_HUDELEMENT( CDODHudWeaponSelection );

//-----------------------------------------------------------------------------
// Purpose: Constructor
//-----------------------------------------------------------------------------
CDODHudWeaponSelection::CDODHudWeaponSelection( const char *pElementName ) : CBaseHudWeaponSelection(pElementName), BaseClass(NULL, "DODHudWeaponSelection")
{
...
void CDODHudWeaponSelection::VidInit(void)
{
...
//-----------------------------------------------------------------------------
void CDODHudWeaponSelection::OnWeaponPickup( C_BaseCombatWeapon *pWeapon )
{
	// show tnt pickup panel
	C_WeaponDODBase *pDODWpn = dynamic_cast<C_WeaponDODBase *>( pWeapon );

	if ( pDODWpn && pDODWpn->GetPCWpnData().m_DODWeaponData.m_WeaponType == WPN_TYPE_BOMB )
	{
...
//-----------------------------------------------------------------------------
void CDODHudWeaponSelection::OnThink()
{
...
//-----------------------------------------------------------------------------
bool CDODHudWeaponSelection::ShouldDraw()
{
	...
	if ( !ToTFPlayer( pPlayer )->IsDODClass() )
		return false;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CDODHudWeaponSelection::LevelInit()
{
...
//-------------------------------------------------------------------------
void CDODHudWeaponSelection::Paint(void)
{
	C_BasePlayer *pPlayer = C_BasePlayer::GetLocalPlayer();
	if ( !pPlayer )
	{
...
//-----------------------------------------------------------------------------
void CDODHudWeaponSelection::DrawBox( int x, int y, int wide, int tall, int type, int number, int valid )
{
...
//-----------------------------------------------------------------------------
void CDODHudWeaponSelection::ApplySchemeSettings( vgui::IScheme *pScheme )
{
...
//-----------------------------------------------------------------------------
void CDODHudWeaponSelection::OpenSelection( void )
{
	Assert( !IsInSelectionMode() );

	CBaseHudWeaponSelection::OpenSelection();
	g_pClientMode->GetViewportAnimationController()->StartAnimationSequence( "DODOpenWeaponSelectionMenu" );
}

//-----------------------------------------------------------------------------
// Purpose: Closes weapon selection control
//-----------------------------------------------------------------------------
void CDODHudWeaponSelection::HideSelection( void )
{
	CBaseHudWeaponSelection::HideSelection();
	g_pClientMode->GetViewportAnimationController()->StartAnimationSequence( "DODCloseWeaponSelectionMenu" );
}

//-----------------------------------------------------------------------------
// Purpose: Returns the next available weapon item in the weapon selection
//-----------------------------------------------------------------------------
C_BaseCombatWeapon *CDODHudWeaponSelection::FindNextWeaponInWeaponSelection( int iCurrentSlot, int iCurrentPosition )
{
	C_BasePlayer *pPlayer = C_BasePlayer::GetLocalPlayer();
	if ( !pPlayer )
	{
...
//-----------------------------------------------------------------------------
C_BaseCombatWeapon *CDODHudWeaponSelection::FindPrevWeaponInWeaponSelection( int iCurrentSlot, int iCurrentPosition )
{
	C_BasePlayer *pPlayer = C_BasePlayer::GetLocalPlayer();
	if ( !pPlayer )
	{
...
//-----------------------------------------------------------------------------
void CDODHudWeaponSelection::CycleToNextWeapon( void )
{
...
//-----------------------------------------------------------------------------
void CDODHudWeaponSelection::CycleToPrevWeapon( void )
{
	// Get the local player.
	C_BasePlayer *pPlayer = C_BasePlayer::GetLocalPlayer();
	if ( !pPlayer )
...
//-----------------------------------------------------------------------------
C_BaseCombatWeapon *CDODHudWeaponSelection::GetWeaponInSlot( int iSlot, int iSlotPos )
{
...
//-----------------------------------------------------------------------------
void CDODHudWeaponSelection::SelectWeaponSlot( int iSlot )
{
...
//-----------------------------------------------------------------------------
void CDODHudWeaponSelection::SelectWeapon( void )
{
...
//-----------------------------------------------------------------------------
void CDODHudWeaponSelection::CancelWeaponSelection( void )
{
	C_BasePlayer *player = C_BasePlayer::GetLocalPlayer();
	if ( !player )
	{
