...
void CDoDCutEditablePanel::ApplySettings( KeyValues *inResourceData )
{
	...
	Q_strncpy( m_szBackgroudColor, inResourceData->GetString( "BackgroundColor", "DOD_HudPanelForeground" ), sizeof( m_szBackgroudColor ) );
	Q_strncpy( m_szBorderColor, inResourceData->GetString( "BackgroundBorder", "DOD_HudPanelBorder" ), sizeof( m_szBorderColor ) );
