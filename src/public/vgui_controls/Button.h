...
enum BUTTON_TYPE
{
	BUTTON_TF, // TF2 is considered our default
	BUTTON_DOD, // Day of Defeat
	BUTTON_PC, // Original Characters
...
public:
	...
	*/
	...
	virtual int  GetButtonTypeReference( void ) { return BUTTON_TF; } // TF is considered default
