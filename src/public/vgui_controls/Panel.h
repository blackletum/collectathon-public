...
enum PANEL_TYPE
{
	PANEL_TF, // TF2 is considered our default
	PANEL_DOD, // Day of Defeat
	PANEL_PC, // Original Characters
	PANEL_CS, // Counter-Strike
	PANEL_HL2, // Half-Life 2
...
public:
	...
	virtual int  GetPanelTypeReference( void ) { return PANEL_TF; } // TF is considered default

	virtual void ColorOverride( IScheme *pScheme );
