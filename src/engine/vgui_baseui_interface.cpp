...
#define LOADGAMELANGUAGE( FILENAME, GAMENAME )													\
	char FILENAME[MAX_PATH];																	\
	Q_snprintf( FILENAME, sizeof( FILENAME ) - 1, "resource/%s_%%language%%.txt", GAMENAME );	\
	FILENAME[ sizeof( FILENAME ) - 1 ] = '\0';													\
	g_pVGuiLocalize->AddFile( FILENAME );														\
...
void CEngineVGui::Init()
{
	...
	// Load language files
	LOADGAMELANGUAGE( szTFLanuage,		"tfbase" );
	LOADGAMELANGUAGE( szSharedLanuage,	"shared" );
	LOADGAMELANGUAGE( szDODLanuage,		"dod" );
	LOADGAMELANGUAGE( szPCLanuage,		"pc" );
	LOADGAMELANGUAGE( szCSLanuage,		"cstrike" );
	LOADGAMELANGUAGE( szHL2Lanuage,		"hl2_override" );
	LOADGAMELANGUAGE( szHL1Lanuage,		"hl1" );
