...
void Button::ApplySchemeSettings(IScheme *pScheme)
{
	...
	// Do our button colour overrides
	ColorOverride( pScheme );
...
//-----------------------------------------------------------------------------
void Button::ColorOverride( IScheme *pScheme )
{
	if ( GetButtonTypeReference() == BUTTON_DOD )
	{
		_defaultFgColor = GetSchemeColor("DOD_Button.TextColor", Color(255, 255, 255, 255), pScheme);
		_defaultBgColor = GetSchemeColor("DOD_Button.BgColor", Color(0, 0, 0, 255), pScheme);

		_armedFgColor = GetSchemeColor("DOD_Button.ArmedTextColor", _defaultFgColor, pScheme);
		_armedBgColor = GetSchemeColor("DOD_Button.ArmedBgColor", _defaultBgColor, pScheme);

		_depressedFgColor = GetSchemeColor("DOD_Button.DepressedTextColor", _defaultFgColor, pScheme);
		_depressedBgColor = GetSchemeColor("DOD_Button.DepressedBgColor", _defaultBgColor, pScheme);
	}
}
