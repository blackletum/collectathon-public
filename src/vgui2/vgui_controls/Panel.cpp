...
//-----------------------------------------------------------------------------
// Purpose: Set default panel colors.
//-----------------------------------------------------------------------------
void Panel::ColorOverride( IScheme *pScheme )
{
	switch ( GetPanelTypeReference() )
	{
		case PANEL_CS:
		{
			SetFgColor(GetSchemeColor("CS_Panel.FgColor", pScheme));
			SetBgColor(GetSchemeColor("CS_Panel.BgColor", pScheme));
			break;
		}
		default:
		{
